  ...
  <div class="mt-6 pt-6 border-t border-dashed border-gray-200">
    ...
    <div class="mb-4 relative z-20">
      <button 
        ...
        class="w-full flex items-center justify-between px-3 py-2.5 bg-[#F7F8FA] border border-[#E5E7EB] rounded-[8px] text-[13px] text-[#333] transition-all active:bg-gray-100"
      >
        <div class="flex items-center gap-2">
          <Car :size="14" class="text-gray-500" />
          <span class="font-medium font-mono">{{ currentVehicle?.vin }}</span>
        </div>
        <ChevronDown 
          :size="16" 
          :class="`text-gray-400 transition-transform duration-200 ${isDropdownOpen ? 'rotate-180' : ''}`" 
        />
      </button>
