...
<template>
  <div class="bg-white rounded-[12px] p-4 shadow-[0_4px_20px_rgba(59,130,246,0.15)] mb-3 mt-0 border-2 border-blue-100 relative overflow-hidden">
    <!-- Highlight Badge -->
    <div class="absolute top-0 right-0 bg-blue-600 text-white text-[9px] px-2 py-0.5 rounded-bl-lg font-bold z-10">本次功能</div>
